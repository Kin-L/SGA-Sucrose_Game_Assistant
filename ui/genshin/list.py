...
class GenshinList:
    def __init__(self, widget, location):
        ...
        self.check_team = Check(self.widget, (15, 50, 140, 22), "切换标准队伍")
        self.check_disp = Check(self.widget, (15, 95, 140, 22), "探索派遣")
        self.check_trans = Check(self.widget, (15, 140, 140, 22), "使用参量质变仪")
        self.check_fly = Check(self.widget, (15, 185, 140, 22), "捕捉晶蝶")
        self.check_comp = Check(self.widget, (15, 230, 140, 22), "合成浓缩树脂")
        self.check_pot = Check(self.widget, (15, 275, 140, 22), "领取尘歌壶")
        self.check_mail = Check(self.widget, (15, 320, 140, 22), "领取邮件")
        self.check_tree = Check(self.widget, (15, 365, 140, 22), "采集木材")
